"""Crop helpers derived from Inpaint Anything (Apache-2.0).

Source: https://github.com/geekyutao/Inpaint-Anything
This vendored copy removes unused plotting/demo code; the crop algorithm is retained.
"""
